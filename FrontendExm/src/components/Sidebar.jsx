...
// New add-on for making sidebar colapsable; more mobile friendly
...
export default function Sidebar() {
  ...
  const [open, setOpen] = useState(false) //For colapsable sidebar
      ...
      >
       ...
       <aside
        className={`
          ...
          ${open ? 'w-60 translate-x-0' : 'w-0 -translate-x-full'}
          md:w-60 md:translate-x-0
        `}
      >
        <div className={`${open ? 'opacity-100' : 'opacity-0 md:opacity-100'} transition-opacity`}>
